...
<body>
    ...
    <section id="shop-header" class="about-header">
        <h2>Choose your payment method &nbsp; <i class="fas fa-money-bill"></i></h2>
        <p></p>
    </section>
    ...
    <div class="wrapper">
        <div class="table basic">
            ...
            <div class="btn"><button onclick="window.location.href='bankpay.php';">Purchase</button></div>
        </div>
        ...
        <div class="table premium">
            ...
            <div class="package-name"></div>
            <div class="btn"><button onclick="window.location.href='mblpay.php';">Purchase</button></div>
        </div>
        ...
        <div class="table ultimate">
            ...
            <div class="package-name"></div>
            <div class="btn"><button onclick="window.location.href='cardpay.php';">Purchase</button></div>
        </div>
        ...
        <div class="table cash">
            ...
            <div class="package-name"></div>
            <div class="btn"><button onclick="window.location.href='cashpay.php';">Purchase</button></div>
        </div>
    </div>
